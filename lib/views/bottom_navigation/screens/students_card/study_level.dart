...
class StudyLevelDropDown extends StatefulWidget {
  @override
  _StudyLevelDropDownState createState() => _StudyLevelDropDownState();
}

class _StudyLevelDropDownState extends State<StudyLevelDropDown> {
  String initialLocation = 'Study Level';
