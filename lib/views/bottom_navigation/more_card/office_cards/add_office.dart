...
class _AddOfficeState extends State<AddOffice> {
  ...
  final GlobalKey<FormBuilderState> _officeFormKey = GlobalKey<FormBuilderState>();
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FormBuilderTextField(
                                  ...
                                  attribute: "city",
                                  decoration:
                                  AppWidgetHelper.textFieldLightIssueDecoration(
                                      true),
                                  style: TextStyle(color: Colors.black),
  ...
  void validateForm() {
    if (_officeFormKey.currentState.saveAndValidate()) {
      ...
      addOfficePost.contact = dlKey + _officeFormKey.currentState.fields["phone"].currentState.value;
      addOfficePost.country = selectedCountry ??
          AffiliateMethods.getUserDefaultCountry(appCheck.countrycode);
      addOfficePost.city = _officeFormKey.currentState.fields["city"].currentState.value;
      addOfficePost.address = _officeFormKey.currentState.fields["address"].currentState.value;
      _officeListBloc.add(AddOfficeEvent(addOfficePostData: addOfficePost));
