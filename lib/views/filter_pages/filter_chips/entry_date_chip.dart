...
class EntryDateChip extends StatelessWidget {
  final List<Startdate> chipLabel;
  final ValueChanged<ChipDeselect> onChipDeSelect;

  EntryDateChip({this.chipLabel, this.onChipDeSelect});
          ...
          if (chipLabel[i].name.isNotEmpty)
            Chip(
              ...
              onDeleted: () {
                ...
                chipDeselect.chipType = Startdate;
